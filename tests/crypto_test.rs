use ec::crypto;
use blind_rsa_signatures::{Sha384, PSS, Randomized, DefaultRng, PublicKey};
use base64::Engine;
...
fn test_crypto_roundtrip() -> anyhow::Result<()> {
    ...
    let randomizer = blinding_result.msg_randomizer.expect("Randomized mode must have a randomizer");
